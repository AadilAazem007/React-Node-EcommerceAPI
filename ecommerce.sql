...
(1, 2, 'Test Udaipur'),
(2, 2, 'test second udaipur'),
(3, 2, 'Test Udaipur'),
(4, 2, 'test second udaipur'),
(5, 2, 'Test Udaipur'),
(6, 2, 'test second udaipur'),
(7, 2, 'Test Udaipur'),
(8, 2, 'test second udaipur'),
(23, 1, 'Tesst Hello'),
(24, 1, 'test second hello');
...
(6, 3, 1, 'Samsung Universe 9', 'https://i.dummyjson.com/data/products/3/thumbnail.jpg', 1249, 4.09, 'pending', 2, '2023-11-28 13:50:45', '2023-11-28 13:50:45'),
(7, 5, 1, 'Huawei P30', 'https://i.dummyjson.com/data/products/5/thumbnail.jpg', 499, 4.09, 'pending', 1, '2023-11-28 13:50:53', '2023-11-28 13:50:53'),
(15, 1, 2, 'iPhone 9', 'https://i.dummyjson.com/data/products/1/thumbnail.jpg', 549, 4.69, 'pending', 1, '2023-11-29 19:02:15', '2023-11-29 19:02:15'),
(21, 10, 2, 'HP Pavilion 15-DK1056WM', 'https://i.dummyjson.com/data/products/10/thumbnail.jpeg', 1099, 4.43, 'pending', 1, '2023-11-29 19:13:33', '2023-11-29 19:13:33'),
(25, 85, 2, 'LouisWill Men Sunglasses', 'https://i.dummyjson.com/data/products/85/thumbnail.jpg', 50, 4.98, 'pending', 1, '2023-11-29 19:35:24', '2023-11-29 19:35:24'),
(26, 56, 2, 'Sneakers Joggers Shoes', 'https://i.dummyjson.com/data/products/56/thumbnail.jpg', 40, 4.38, 'pending', 1, '2023-11-29 19:37:54', '2023-11-29 19:37:54');
...
CREATE TABLE `products` (
  ...
  `description` varchar(209) NOT NULL,
  `price` int(11) NOT NULL,
